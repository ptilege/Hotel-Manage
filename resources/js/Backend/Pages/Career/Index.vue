            ...
            <div class="card-header pb-0">
              ...
              <div class="d-flex">
                <Link
                  ...
                  v-if="$root.hasPermission('career.create')"
                >
  ...
  props:{
    ...
    mounted() {
      ...
      $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
        ...
        this.$inertia.visit(route("careers.edit", id));
      });
    ...
    methods: {
      ...
      updateStatus(id, status) {
        ...
        this.form.put(route("careers.status"), {
          preserveScroll: true,
          onSuccess: () => {
            this.form.reset();
            this.reloadTable();
