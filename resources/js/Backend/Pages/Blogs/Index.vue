          ...
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                v-if="$root.hasPermission('blog.create')"
              >
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("blogs.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("blogs.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
