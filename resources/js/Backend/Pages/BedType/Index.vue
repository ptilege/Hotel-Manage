      ...
      <div class="col-md-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h5>Backend Bed Types</h5>
            <p>Manage Backend Bed Types.</p>
            <div class="d-flex">
              <Link
                class="btn btn-primary btn-sm"
                :href="route('bed.types.create')"
                v-if="$root.hasPermission('bed-type.create')"
              >
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("bed.types.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("bed.types.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
