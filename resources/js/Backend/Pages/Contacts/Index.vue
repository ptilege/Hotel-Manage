          ...
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                v-if="$root.hasPermission('contact.create')"
              >
...
export default {
  ...
  data() {
    return {
      columns: [
        ...
        { data: "room_info", name: "room_info", orderable: false, searchable:true },
        {
          data: "checkin_date",
          name: "checkin_date",
          orderable: false,
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("contact.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("contact.change.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
