      ...
      <div class="col-md-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            ...
            <p>Manage Property Types.</p>
            <div class="d-flex">
              <Link
                class="btn btn-primary btn-sm"
                :href="route('property.types.create')"
                v-if="$root.hasPermission('property-type.create')"
              >
          ...
          <div class="card-body">
            <data-table
              ref="datatable"
              :id="'mytable'"
              :url="route('property.types.getdata')"
              :columns="columns"
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("property.types.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("property.types.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
    ...
    deleteSelectedItems() {
      this.form
        ...
        .post(route("property.types.delete"), {
          onSuccess: () => {
            this.resetForm();
            this.reloadTable();
            this.$root.showMessage(
