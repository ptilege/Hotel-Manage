      ...
      <div class="col-md-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h5>Backend Meal Types</h5>
            <p>Manage Backend Meal Types.</p>
            <div class="d-flex">
              <Link
                class="btn btn-primary btn-sm"
                :href="route('meal.types.create')"
                v-if="$root.hasPermission('meal-type.create')"
              >
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("meal.types.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("meal.types.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
