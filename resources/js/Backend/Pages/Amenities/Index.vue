          ...
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                v-if="$root.hasPermission('amenities.create')"
              >
...
props:{
  ...
  data() {
    return {
      ...
      order: [[1, "desc"]],
      url:route('amenities.getdata')+'?property=',
      form: useForm({
        id: "",
        status: "",
      }),
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("amenities.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("amenities.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
