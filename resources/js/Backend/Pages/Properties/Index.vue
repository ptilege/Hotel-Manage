    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                v-if="$root.hasPermission('property.create')"
              >
          ...
          <th>Contact</th>
          <th>Status</th>
          <th>Partner Name</th> <!-- Added column for partner name -->
          <th>Action</th>
        </tr>
              </template>
            </data-table>
...
export default {
  ...
  data() {
    return {
      columns: [
        ...
        {
          data: "partner", // Update to the actual path in the fetched data
          name: "partner",
          orderable: false,
          searchable: true,
          title: "Partner Name",
          render: function (data) {
            return data ? data : "No Partner";
          },
        },
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("properties.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("properties.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
