          ...
          <div class="card-header">
            ...
            <div class="d-flex">
              <button
                ...
                v-if="form.c != 'default'"
              >
                <i class="bx bx-left-arrow-alt" style="margin-top: -2px"></i
                >Back
              </button>
                    ...
                    >
                      <div class="card border overflow-hidden">
                        ...
                        <div class="card-footer p-0 p-2">
                          <div class="image-name text-capitalize">
                            {{ collection.name ?? "" }}
                          </div>
                        </div>
                      </div>
                    ...
                    >
                      <div class="card border">
                        ...
                        <div class="card-footer p-0 p-2 position-relative">
                          <div class="image-name text-capitalize">
                            {{ limitChars(media.name ?? "", 12) }}
                          </div>
                          <div
                            class="image-name text-capitalize"
                            style="font-size: 12px"
                          >
                            {{ humanReadableSize(media.size ?? 0) }}
                          </div>
                          <button
                            type="button"
                            class="
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                              <a
                                ...
                                "
                              >
                                <i class="bx bx-show"></i> Preview</a
                              >
                            </li>
                            <li>
                              <a
