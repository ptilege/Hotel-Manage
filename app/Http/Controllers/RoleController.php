...
class RoleController extends Controller
{
    ...
    public function getData()
    {
        ...
        return DataTables::of($users)
            ...
            ->rawColumns(['check', 'action', 'user_role'])
            ->make(true);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Roles/CreateUpdate', ['allPermissions' => $allPermissions, 'roleTypes'=>$roleTypes]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            DB::beginTransaction();
            Role::create(['guard_name' => 'web', 'name' => $request->role_name, 'type'=>$request->type]);
            DB::commit();
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Roles/CreateUpdate', ['role' => $role, 'roleTypes'=>$roleTypes]);
    }
